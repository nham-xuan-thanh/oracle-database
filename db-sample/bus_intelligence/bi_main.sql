...
@/opt/oracle/product/19c/dbhome_1/demo/schema/db-sample/bus_intelligence/bi_oe_pr.sql &pwd_oe &connect_string
...
@/opt/oracle/product/19c/dbhome_1/demo/schema/db-sample/bus_intelligence/bi_sh_pr.sql &pwd_sh &connect_string

REM =======================================================
REM  Views and synonyms in the 10i BI schema
REM =======================================================

@/opt/oracle/product/19c/dbhome_1/demo/schema/db-sample/bus_intelligence/bi_views.sql &pwd_bi &connect_string
