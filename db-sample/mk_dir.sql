...
CREATE OR REPLACE DIRECTORY data_file_dir AS '/opt/oracle/product/19c/dbhome_1/demo/schema/db-sample/sales_history/'; 
CREATE OR REPLACE DIRECTORY log_file_dir  AS '/opt/oracle/product/19c/dbhome_1/demo/schema/db-sample/log/'; 
CREATE OR REPLACE DIRECTORY media_dir     AS '/opt/oracle/product/19c/dbhome_1/demo/schema/db-sample/product_media/';
