...
@/opt/oracle/product/19c/dbhome_1/demo/schema/db-sample/mk_dir
...
@/opt/oracle/product/19c/dbhome_1/demo/schema/db-sample/human_resources/hr_code
...
@/opt/oracle/product/19c/dbhome_1/demo/schema/db-sample/order_entry/oe_main.sql &&password_oe EXAMPLE TEMP  &&password_hr &&password_sys &&oe_data_path &&log_path &vrs
...
@/opt/oracle/product/19c/dbhome_1/demo/schema/db-sample/bus_intelligence/bi_views.sql &&password_bi
...
connect oe/&&password_oe;
@/opt/oracle/product/19c/dbhome_1/demo/schema/db-sample/order_entry/oe_analz
connect pm/&&password_pm;
@/opt/oracle/product/19c/dbhome_1/demo/schema/db-sample/product_media/pm_analz
connect hr/&&password_hr;
@/opt/oracle/product/19c/dbhome_1/demo/schema/db-sample/human_resources/hr_analz
connect sh/&&password_sh
@/opt/oracle/product/19c/dbhome_1/demo/schema/db-sample/sales_history/sh_analz
