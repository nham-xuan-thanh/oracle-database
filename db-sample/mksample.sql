...
@/opt/oracle/product/19c/dbhome_1/demo/schema/db-sample/human_resources/hr_main.sql &&password_hr &&default_ts &&temp_ts &&password_sys &&logfile_dir &&connect_string

CONNECT system/&&password_system@&&connect_string
SET SHOWMODE OFF

@/opt/oracle/product/19c/dbhome_1/demo/schema/db-sample/order_entry/oe_main.sql &&password_oe &&default_ts &&temp_ts &&password_hr &&password_sys /opt/oracle/product/19c/dbhome_1/demo/schema/db-sample/order_entry/ &&logfile_dir &vrs &&connect_string

CONNECT system/&&password_system@&&connect_string

SET SHOWMODE OFF

@/opt/oracle/product/19c/dbhome_1/demo/schema/db-sample/product_media/pm_main.sql &&password_pm &&default_ts &&temp_ts &&password_oe &&password_sys /opt/oracle/product/19c/dbhome_1/demo/schema/db-sample/product_media/ &&logfile_dir /opt/oracle/product/19c/dbhome_1/demo/schema/db-sample/product_media/ &&connect_string

CONNECT system/&&password_system@&&connect_string
SET SHOWMODE OFF

@/opt/oracle/product/19c/dbhome_1/demo/schema/db-sample/info_exchange/ix_main.sql &&password_ix &&default_ts &&temp_ts &&password_sys &&logfile_dir &vrs &&connect_string

CONNECT system/&&password_system@&&connect_string
SET SHOWMODE OFF

@/opt/oracle/product/19c/dbhome_1/demo/schema/db-sample/sales_history/sh_main &&password_sh &&default_ts &&temp_ts &&password_sys /opt/oracle/product/19c/dbhome_1/demo/schema/db-sample/sales_history/ &&logfile_dir &vrs &&connect_string

CONNECT system/&&password_system@&&connect_string
SET SHOWMODE OFF

@/opt/oracle/product/19c/dbhome_1/demo/schema/db-sample/bus_intelligence/bi_main &&password_bi &&default_ts &&temp_ts &&password_sys &&password_oe &&password_sh &&logfile_dir &vrs &&connect_string
...
@/opt/oracle/product/19c/dbhome_1/demo/schema/db-sample/mkverify &&password_system &veri_spool &&connect_string
