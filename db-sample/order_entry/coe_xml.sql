...
-- Create stored objects
   @/opt/oracle/product/19c/dbhome_1/demo/schema/db-sample/order_entry/xdbSupport


-- Create directory object, instantiated by createUser.sql.sbs
 @/opt/oracle/product/19c/dbhome_1/demo/schema/db-sample/order_entry/createUser &pass_oe &pass_sys &connect_string
...
-- Create folders and load
 @/opt/oracle/product/19c/dbhome_1/demo/schema/db-sample/order_entry/xdb03usg
