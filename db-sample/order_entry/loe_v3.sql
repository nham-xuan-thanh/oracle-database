...
@/opt/oracle/product/19c/dbhome_1/demo/schema/db-sample/order_entry/oe_p_pi

@/opt/oracle/product/19c/dbhome_1/demo/schema/db-sample/order_entry/oe_p_pd

DEFINE vscript = /opt/oracle/product/19c/dbhome_1/demo/schema/db-sample/order_entry/pwhs_&vrs
@&vscript

DEFINE vscript = /opt/oracle/product/19c/dbhome_1/demo/schema/db-sample/order_entry/pcus_&vrs
@&vscript

DEFINE vscript = /opt/oracle/product/19c/dbhome_1/demo/schema/db-sample/order_entry/pord_&vrs
@&vscript

@/opt/oracle/product/19c/dbhome_1/demo/schema/db-sample/order_entry/oe_p_itm

@/opt/oracle/product/19c/dbhome_1/demo/schema/db-sample/order_entry/oe_p_inv
