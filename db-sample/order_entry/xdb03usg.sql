...
--
@/opt/oracle/product/19c/dbhome_1/demo/schema/db-sample/order_entry/createFolders.sql


--
-- Load example documents into the XDB repository
--
@/opt/oracle/product/19c/dbhome_1/demo/schema/db-sample/order_entry/createResources.sql
