...
-- Prepare environment
@/opt/oracle/product/19c/dbhome_1/demo/schema/db-sample/order_entry/xdbConfiguration
@/opt/oracle/product/19c/dbhome_1/demo/schema/db-sample/order_entry/xdbUtilities
